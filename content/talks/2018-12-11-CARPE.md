...
status: published
cover: /img/2018-12-11__carpe__cpu-slide.png
---

@ **CARPE December Meeting**, *Columbus, Ohio*

[Slides](https://drive.google.com/open?id=12KYvWFvr7uSeOLgl2vSXf_TAWIMcBV3WC4VD1vP2Oag)

```bash
git clone --branch 2018-12-11-CARPE https://y2kbugger@github.com/y2kbugger/sapy.git
```

![Slide about my CPU presentation.](../img/2018-12-11__carpe__cpu-slide.png)
